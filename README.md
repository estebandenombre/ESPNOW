...
**Nota:** El rango del sensor de luz va comprendido desde 0 hasta 4095 siendo el primero muestra de claridad y el último de oscuridad. Sin embargo, el rango no se tiene en cuenta debido al conversor Analógico Digital del ESP32. 
...
![Diagrama sobre los diferentes modos](Diagrama en blaco.png)
